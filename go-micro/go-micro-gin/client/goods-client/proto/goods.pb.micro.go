...
func (c *goodsService) AddGoods(ctx context.Context, in *AddRequest, opts ...client.CallOption) (*AddResponse, error) {
...
func (h *goodsHandler) AddGoods(ctx context.Context, in *AddRequest, out *AddResponse) error {
